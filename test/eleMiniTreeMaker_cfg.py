...
from MiniTree.LocalRunSkeleton_cff import *
from MiniTree.ttSemiLepKinFitElectron_cff import *
from MiniTree.LocalSources_cff import toPrint
...
process.myMiniTreeProducer.Trigger.myTrig = "HLT_Ele"
