...
int                                   "kinFitTtSemiLepEvent"      "NumberOfConsideredJets"   "TEST"    
vector<double>                        "kinFitTtSemiLepEvent"      "Chi2"            "TEST"    
vector<double>                        "kinFitTtSemiLepEvent"      "Prob"            "TEST"    
vector<int>                           "kinFitTtSemiLepEvent"      "Status"          "TEST"    
vector<pat::Particle>                 "kinFitTtSemiLepEvent"      "Leptons"         "TEST"    
vector<pat::Particle>                 "kinFitTtSemiLepEvent"      "Neutrinos"       "TEST"    
vector<pat::Particle>                 "kinFitTtSemiLepEvent"      "PartonsHadB"     "TEST"    
vector<pat::Particle>                 "kinFitTtSemiLepEvent"      "PartonsHadP"     "TEST"    
vector<pat::Particle>                 "kinFitTtSemiLepEvent"      "PartonsHadQ"     "TEST"    
vector<pat::Particle>                 "kinFitTtSemiLepEvent"      "PartonsLepB"     "TEST"    
vector<vector<int> >                  "kinFitTtSemiLepEvent"      ""                "TEST"    
