...
scaledJetEnergy = cms.EDProducer("JetEnergyScale",
    ...
    resolutionsFile   = cms.FileInPath("MiniTree/Selection/data/Spring16_25nsV10_MC_PtResolution_AK4PF.txt")
)

#####################################
# JER values used in KinFit
# https://github.com/ravindkv/MiniTree/blob/283faa0a2008bc1e3ef2660e9f69cff49c95b729/Selection/python/ttSemiLepKinFitMuon_cff.py
