...
scaledJetEnergy = cms.EDProducer("JetEnergyScale",
    ...
    JECUncSrcFile        = cms.FileInPath("MiniTree/Utilities/data/80X_mcRun2_asymptotic_2016_TrancheIV_v8_Uncertainty_AK4PFchs.txt"),
    resolutionsFile   = cms.FileInPath("MiniTree/Utilities/data/Summer16_25nsV1_MC_PtResolution_AK4PF.txt"),
    scaleFactorsFile  = cms.FileInPath("MiniTree/Utilities/data/Summer16_25nsV1_MC_SF_AK4PF.txt")
)
